...
* Matrix inversion.
*
* @param <az> the square matrix.
* @param <jaz> the dimension of the az matrix.
* @param <n> the demension of left-top submatrix of matrix az to be inversed.
* @param <a> the square matrix of demension ja x ja, where are placed the inversed matrix.
* @param <ja> the dimension of the a matrix.
*
* @return 1 if matrix is singular, else 0.
*/
//------------------------------------------------------------------------------
int JVC_DLL obmatr(double *az,int jaz,int n,double *a,int ja )
{
...
*
* @param <el> the vector of nonsingular elements.
* @param <pme> transition matrix of dimension 7x7.
* @param <delvre> the prediction interval in days.
*
*/
//------------------------------------------------------------------------------
void JVC_DLL vpm(double el[],double pme[7][7],double delvre)
...
//------------------------------------------------------------------------------
/**
* Calculates the xyz rad.
*
* @param <radius> the radius.
* @param <alfa> the value of alfa.
...
//------------------------------------------------------------------------------
/**
* Calculates the partial derivative matrix.
*
* @param <e> the vector of nonsingular elements.
* @param <D> the partial derivative matrix.
*
*/
//------------------------------------------------------------------------------
void JVC_DLL D_xyz_alambda(double e[6],double D[6][6])
...
//------------------------------------------------------------------------------
// void JVC_DLL REDUCTION(double alfa,double delta,double JD1957,int Epocha, int Psr,double *d_alfa,double *d_delta)
//------------------------------------------------------------------------------
/**
* Calculates the reduction.
*
* @param <alfa> the vvalue of alfa.
* @param <delta> the vvalue of delta.
* @param <JD1957> the vvalue of JD1957.
* @param <Epocha> the vvalue of Epocha.
* @param <Psr> the vvalue of Psr.
* @param <d_alfa> the vvalue of d_alfa.
* @param <d_delta> the vvalue of d_delta.
*
*/
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
/**
* Transformation of the position and velocity in the quasinertial coordinate system
* to the coordinate system  related to the epoch of date.
*
* @param <X> the position and velocity vector.
* @param <T> the time counted off from 0h UTC Dec 31 1957.
* @param <p> if P=0 then the output data should be produced in the True Eqinox and True Equator of Date frame,
...
* @param <X> the position and velocity vector.
* @param <T> the time counted off from 0h UTC Dec 31 1957.
* @param <p> if P=0 then the input data are presented in the True Eqinox and Equator of Date,
...
//------------------------------------------------------------------------------
// void JVC_DLL KEP_TO_LAP(double A,double I,double w,double DBY,double T, double *IL,
//                         double *wL,double *DBYL,double *LL)
//------------------------------------------------------------------------------
/**
*The kep_to_lap function.
*
* @param <A> the value of A.
* @param <I> the value of I.
* @param <w> the value of w.
* @param <DBY> the value of DBY.
* @param <T> the value of T.
* @param <IL> the value of IL.
* @param <wLp> the value of wL.
* @param <DBYL> the value of DBYL.
* @param <LL> the value of LL.
*
*/
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
/**
*The PROGNOZ_KMO function.
*
* @param <EL> the value of EL.
* @param <KMO> the KMO matrix.
* @param <DELT> the value of DELT.
* @param <EK> the value of EK.
* @param <radius> the value of radius.
* @param <alfa> the value of alfa.
* @param <delta> the value of delta.
* @param <P> the value of P.
* @param <C> the C matrix.
* @param <C2> the C2 matrix.
*
*/
//------------------------------------------------------------------------------
void JVC_DLL PROGNOZ_KMO(double EL[],double KMO[7][7],double DELT,double EK[],
...
//------------------------------------------------------------------------------
/**
*The GRAD_RAD1 function.
*
* @param <gmsds> the value of gmsds.
* @param <rdr> the value of rdr.
...
//------------------------------------------------------------------------------
/**
*The STR_TIME function.
*
* @param <t> the value of the time.
* @param <dmg> the value of dmg.
* @param <ch_m_s> the value of ch_m_s.
* @param <k> the value of k.
*
*/
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
/**
*The GNSK_V_GPSK function.
*
* @param <E0> the value of E0.
* @param <S> the value of S.
* @param <prz> the value of prz.
* @param <EK> the value of EK.
*
*/
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
/**
*The CH_M_SToDelta function.
*
* @param <s_delta> the value of s_delta.
*
*/
//------------------------------------------------------------------------------
double JVC_DLL CH_M_SToDelta(char s_delta[])
