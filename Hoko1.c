...
//------------------------------------------------------------------------------
/**
* Input of the Earth gravity field coefficients.
*
* @return true if inputting was succesful, false if it was detected input error.
*/
//------------------------------------------------------------------------------
;
int JVC_DLL GEM_input (void)
...
//------------------------------------------------------------------------------
/*
* Determinates the sign of a number.
*
* @param <X> the number to determinate the sign.
*
* @return the sign o the number.
*/
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
/*
* Return the defined constant DEMO
*
* @param <i>
*
* @return the boolean  value of DEMO
*/
//------------------------------------------------------------------------------
;
int JVC_DLL demo(int i)
...
//------------------------------------------------------------------------------
/**
* Calculation of Kepler equation.
*
* @param <M> the mean anomaly in radian.
* @param <EKC> the eccentricity.
*
* @return the eccentric anomaly in radian.
*/
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
/**
* Calculation of right ascension and declination of the Sun.
*
* @param <T> the is time in days from 0h UTC Dec 31 1957.
* @param <ALF> the right ascension of the Sun in radiian.
* @param <DEL> the right declination of the Sun in radiian.
*
*/
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
/**
* Transformation of Kepler elements to coordinates and velocities.
*
* @param <E0>
* @param <EK>
*
* @return the result of the Kepler transformation.
*/
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
/**
* Transformation of coordinates and velocities to nonsingular elements.
*
* @param <X>
* @param <E>
*
...
//------------------------------------------------------------------------------
/**
* Transformation of nonsingular elements to Kepler elements.
*
* @param <E>
* @param <E1>
*
* @return the kepler elements.
*/
//------------------------------------------------------------------------------
...
*
* @return the kepler elements.sidereal time in radian.
*/
//------------------------------------------------------------------------------
;
double JVC_DLL ST(int D,double T0)
...
//------------------------------------------------------------------------------
/**
* Transformation of Kepler elements to nonsingular elements.
*
* @param <E>
* @param <E1>
*
* @return the nonsingular elements.
*/
//------------------------------------------------------------------------------
...
* of order two due to the second zonal garmonics.
*
* @note It is used variables, declared as global:
*       A(axis),E (eccentricity), SI(), CI2 (),CI2(), I (inclination).
*
*/
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
/**
* Calculation of function b =b*(a!/(k!*(a-k)!).
*
* @param <B>
* @param <A>
* @param <K>
*
* @return the result of function value calculation.
*/
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
/**
* Calculation of inclination function and its derivative.
*
* @param <L>
* @param <M>
* @param <P>
* @param <S>
* @param <C>
* @param <FF1> the value of inclination function.
...
//------------------------------------------------------------------------------
/**
* Calculation of Hansen function and its derivative.
*
* @param <N>
* @param <P>
* @param <Q>
* @param <E>
* @param <A> the value of Hansen function.
* @param <A1> the derivative of Hansen function.
*
*/
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
/**
* Calculation of Hansen function.
*
...
*        SI2(),CI2 (), I (inclination)
*        static arrays with results of functioon calculation
*        QQ[],PP[],RR[],TT[].
*
*/
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
/**
* Calculation of atmosphere density value without bulge.
*
* @param <H1> the altitude in km.
* @param <F81> the weighting-averaged value of solar activity index for preceding 81 days.
* @param <F> the daily averaged values of solar activity index.
* @param <F0> the model's fixed level of solar activity index.
* @param <KP> the daily averaged planetary index of geomagnetic activity.
* @param <T0> the time in days count of from 0h UTC Dec 31 1957..
*
* @return RO is atmospheric density value in kg/(m*m*km).
*/
//------------------------------------------------------------------------------
...
*
* @param <H1> the altitude in km.
* @param <F135> the weighting-averaged value of solar activity index for preceding 135 days.
* @param <F> the daily averaged values of solar activity index.
* @param <F0> the model's fixed level of solar activity index.
* @param <KP> the daily averaged planetary index of geomagnetic activity.
* @param <T0> the time in days count of from 0h UTC Dec 31 1957.
...
//------------------------------------------------------------------------------
/**
* Calculation of Bessel function I0.
*
* @param <X> the value of x.
*
* @return Y is value of Bessel function I0.
*/
//------------------------------------------------------------------------------
;
double JVC_DLL I0(double X)
...
//------------------------------------------------------------------------------
/**
* Calculation of Bessel function I1.
*
* @param <X> the value of x.
*
* @return Y is value of Bessel function I1.
*/
//------------------------------------------------------------------------------
...
* @param <f107> the value of f107.
* @param <f81> the value of f81.
* @param <kp> the value of kp.
*
*/
//------------------------------------------------------------------------------
;
