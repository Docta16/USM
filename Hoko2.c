...
//------------------------------------------------------------------------------
/**
* Calculation of all inclination and its derivatives up to order L2.
*
* @param <L2> the order.
* @note Output data: dynamic array FF with value of inclination function
*       and its derivatives.
*
*/
//------------------------------------------------------------------------------
...
*
* @param <PKP> the option for calculation of short periodical perturbations
*          at initial or final points.
* @param <EBX> the vector of nonsingular elements.
* @param <T> the time counted off from 0h UTC Dec 31 1957.
* @param <E1> the vector of short periodical perturbations.
*
