...
//
/**
* File header that includes all the functions that the USM software needs.
*
*/
//------------------------------------------------------------------------------
#ifndef HOKO_H
...
#define DEMO 0                   // It is used for creation Demo version
