...
//------------------------------------------------------------------------------
/**
* Calculation of the Moon and Sun coordinates at requestion time.
*
* @param <TM> the time in days from 0h UTC Dec 31, 1957.
* @param <XL> the x coordinate of the moon.
* @param <YL> the y coordinate of the moon.
* @param <ZL> the z coordinate of the moon.
* @param <XC> the x coordinate of the Sun.
* @param <YC> the y coordinate of the Sun.
* @param <ZC> the z coordinate of the Sun.
*
*/
//------------------------------------------------------------------------------
void JVC_DLL KOOPLS(double TM,double far *XL,double far *YL,double far *ZL,double far *XC,double far *YC,double far *ZC)
...
//------------------------------------------------------------------------------
/**
* Calculation of spherical functions value.
*
* @param <X> coordinate x.
* @param <Y> coordinate y.
* @param <Z> coordinate z.
* @param <LK> maximum order of spherical functions to be calculated.
* @param <HLC> Array of values of spherical functions.
*
*/
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
/**
* Calculation of slow-changing resonance functions
*
* @note It is used variables, declared as global:
*	A(semimajor axis, km), E (eccentricity),
*       SI2(),CI2 (), I (inclination),static array JREZ[],
*       dynamic arrays QC[], PC[], PD[], RC[], RD[], TC[], TD[].
*/
//------------------------------------------------------------------------------
...
* due to attraction of the Moon and Sun.
*
* @note It is used variables, declared as global:
*	E (eccentricity),SI2(),CI2 (), I (inclination),
*       maximum order of parallactic terms LLUN,
*       dynamic arrays LE[], LI[], LV[], LPI[], LLAM[].
*/
//------------------------------------------------------------------------------
...
*
* @param <DT> the step of approximation.
* @param <T> the initial time.
* @param <TK> th3 final time.
* @param <THAX>
* @param <TKOH>
*
*/
...
void JVC_DLL APPROK(double DT,double T,double TK,double far *THAX,double far *TKOH)
{
    ...
    if  ((T<*THAX) || (T>*TKOH))
    {
        ...
        for  (K=0; K<=4; K++)
        {
            ...
            case 0:
            {
                UV(XL,YL,ZL,LLUN,HL0)
                ;
                UV(XC,YC,ZC,LSUN,HC0) ;
                break;
            }
            ;
            case 1:
            {
                UV(XL,YL,ZL,LLUN,ML1)
                ;
                UV(XC,YC,ZC,LSUN,MC1) ;
                break;
            }
            ;
            case 2:
            {
                UV(XL,YL,ZL,LLUN,ML2)
                ;
                UV(XC,YC,ZC,LSUN,MC2) ;
                break;
            }
            ;
            case 3:
            {
                UV(XL,YL,ZL,LLUN,ML3)
                ;
                UV(XC,YC,ZC,LSUN,MC3) ;
                break;
            }
            ;
            case 4:
            {
                UV(XL,YL,ZL,LLUN,ML4)
                ;
                UV(XC,YC,ZC,LSUN,MC4) ;
                break;
            }
            ;
            }
...
//------------------------------------------------------------------------------
// void JVC_DLL SHADOW(double al,double del,double AP,double DBY,double *E1,double *E2,double *S,double *T,double *W)
//------------------------------------------------------------------------------
/**
* Calculation of shadow entry and exit parameters.
*
* @param <al>
* @param <del>
* @param <AP>
